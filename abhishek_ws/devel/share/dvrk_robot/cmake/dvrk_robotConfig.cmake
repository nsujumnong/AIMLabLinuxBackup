...
if("TRUE" STREQUAL "TRUE")
  set(dvrk_robot_SOURCE_PREFIX /home/davincic3/abhishek_ws/src/dvrk-ros/dvrk_robot)
  set(dvrk_robot_DEVEL_PREFIX /home/davincic3/abhishek_ws/devel)
  ...
  set(dvrk_robot_INSTALL_PREFIX /home/davincic3/abhishek_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dvrk_robot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'dvrk_robot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/davincic3/abhishek_ws/src/dvrk-ros/dvrk_robot/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${dvrk_robot_dep}_FOUND)
      find_package(${dvrk_robot_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${dvrk_robot_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
