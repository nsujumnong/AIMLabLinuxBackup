...
public:
    ...
    : it_(nh_)
  {
    ...
    image_sub_right = it_.subscribe("/dv_vp_camera/right", 1, &StereoEditDualAccess::imageCbR, this);
    ...
    //Left Eye
    // Subscribe to input video feed and publish output video feed
    image_sub_left = it_.subscribe("/dv_vp_camera/left", 1, &StereoEditDualAccess::imageCbL, this);
